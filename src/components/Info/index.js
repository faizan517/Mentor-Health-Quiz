...
import { CContainer, CForm, CRow, CCol, CFormLabel, CFormInput, CFormFeedback, CFormSelect, CButton } from '@coreui/react';
...
const Info = ({ onInputChange ,onInfoSubmit}) => {
 ...
 const onSubmit = (data) => {
  ...
  return (
    <CContainer className="my-5 mt-5">
